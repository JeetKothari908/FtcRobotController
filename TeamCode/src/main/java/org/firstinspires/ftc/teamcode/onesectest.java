...
@Autonomous(name="1sectest", group="Autonomous")
public class onesectest extends LinearOpMode {
...
//        bl.setPower(0);
//        br.setPower(0);
        telemetry.addLine("motor at "+fr.getCurrentPosition());
        telemetry.addLine("motor at "+fl.getCurrentPosition());
        telemetry.addLine("motor at "+br.getCurrentPosition());
        telemetry.addLine("motor at "+bl.getCurrentPosition());
