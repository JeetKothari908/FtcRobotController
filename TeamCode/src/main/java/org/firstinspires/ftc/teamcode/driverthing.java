...
//                    tmp.add(c.get(i, j)[2]);
    ...
    public boolean center(double[][][] array_of_pixels){
        int line_num  = (int)array_of_pixels.length/3;
        double[][] line_of_pixels = array_of_pixels[line_num];
        ...
        else if (yellows <= line_of_pixels.length/2 - 20) {
            return false;
        }
        else{
            centered = false;
    ...
    public int yellow1;
    public boolean f(double[][][] array_of_pixels){
        int line_num  = (int)array_of_pixels.length/3;
        double[][] line_of_pixels = array_of_pixels[line_num];
        int yellow_counter = 0;
        int yellows = 0;
